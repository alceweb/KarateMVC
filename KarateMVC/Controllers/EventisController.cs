...
namespace KarateMVC.Controllers
{
    public class EventisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Titolo,Descrizione,Data,Pubblica,Approfondimento,Galleria")] Eventi eventi)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Titolo,Descrizione,Data,Pubblica,Approfondimento,Galleria")] Eventi eventi)
        {
            if (ModelState.IsValid)
            {
